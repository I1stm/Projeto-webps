...
const CorpoHumano = ({ aoSelecionar, parteAtiva, vista = 'frente' }) => {
  ...
  const estilo = (id) => ({
    ...
    filter: parteAtiva === id ? 'drop-shadow(0 0 10px var(--destaque))' : 'none'
  });
    ...
    <svg viewBox="0 0 400 800" style={{ width: '100%', height: '100%', display: 'block' }}>
      ...
      {vista === 'frente' && (
        <g transform="translate(100, 50)">
          ...
          {/* Braços (Com hífen para bater com o banco) */}
      ...
      {vista === 'costas' && (
        <g transform="translate(100, 50)">
          ...
          {/* Costas: Mantemos o ID do SVG único para desenho, mas enviamos o ID lógico correto no clique */}
